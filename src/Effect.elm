...
port sendToElmCompilerPort : { elmCode : String } -> Cmd msg
...
type Effect msg
    ...
    | SendToElmCompiler
        { elmCode : String
        , onResponse : Result Http.Error CompilerData -> msg
        }
...
map fn effect =
    case effect of
        ...
        SendToElmCompiler { elmCode, onResponse } ->
            SendToElmCompiler
                { elmCode = elmCode
                , onResponse = \result -> fn (onResponse result)
                }
